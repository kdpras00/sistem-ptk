...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-white">Edit Kategori Dokumen</h1>
            <p class="text-white">Update informasi kategori {{ $category->nama_kategori }}</p>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="p-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="kode_kategori" id="kode_kategori" value="{{ old('kode_kategori', $category->kode_kategori) }}" 
                       ...
                       placeholder="contoh: SK-001, IJZ-001, SRT-001" required readonly>
            ...
            <div class="p-4 bg-blue-50 border-l-4 border-blue-400">
                <p class="text-sm text-blue-700">
                    <strong>Perhatian:</strong> Kategori ini memiliki {{ $category->documents()->count() }} dokumen terkait. Perubahan kode kategori dapat mempengaruhi sistem pengarsipan.
                </p>
            </div>
            @endif
        </div>
