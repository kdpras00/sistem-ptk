...
class PTKController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'nip' => 'required|unique:ptk,nip|max:18',
            'nama_lengkap' => 'required|string|max:255',
            'nuptk' => 'nullable|string|max:18',
            'jenis_kelamin' => 'required|in:L,P',
            'tanggal_lahir' => 'required|date',
            'tempat_lahir' => 'required|string',
            'alamat' => 'required|string',
            'no_telepon' => 'nullable|string|max:20',
            'status_kepegawaian' => 'required|in:PNS,PPPK,GTT,GTY,Honorer',
            'jabatan' => 'required|in:Kepala Sekolah,Wakil Kepala Sekolah,Bendahara Sekolah,Wakasek Kurikulum,Wakasek Kesiswaan,Guru Mapel,Tenaga Kependidikan',
            'pangkat_golongan' => 'nullable|in:III/a,III/b,III/c,III/d,IV/a,IV/b,IV/c,IV/d,IV/e,GTY,GTT',
    ...
    public function update(Request $request, PTK $ptk)
    {
        $validated = $request->validate([
            ...
            'role' => 'required|in:guru,staf_tu,kepala_sekolah',
            'nip' => 'required|max:18|unique:ptk,nip,' . $ptk->id,
            'nama_lengkap' => 'required|string|max:255',
            'nuptk' => 'nullable|string|max:18',
            'jenis_kelamin' => 'required|in:L,P',
            'tanggal_lahir' => 'required|date',
